        ...
        emailjs
            ...
            .then(
                () => {
                    setLoading(false);
                    alert(
                        "Thank you, i will get back to you as son as possible"
                    );
                    Setform({
                        name: "",
                        email: "",
        ...
        <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden z-[1] '>
            ...
            >
                ...
                >
                    ...
                    <button
                        type='submit'
                        className='bg-tertiary py-3 px-8 font-bold shadow-md shadow-primary rounded-xl w-fit text-white outline-none'
                    >
